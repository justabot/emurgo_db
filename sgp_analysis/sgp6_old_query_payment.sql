https://explain.depesz.com/s/hf85
Time: 20727.844 ms (00:20.728)
...
with
    hashes as (
     ...
     WHERE  address = ANY(('{}')::varchar array)
     OR payment_cred = ANY(('{\\x220099e5e430475c219518179efc7e6c8289db028904834025d5b086}')::bytea array)
